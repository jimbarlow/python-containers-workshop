...
Collecting Werkzeug>=0.15 (from flask==1.1.2->-r requirements.txt (line 1))
  Downloading https://files.pythonhosted.org/packages/cc/94/5f7079a0e00bd6863ef8f1da638721e9da21e5bacee597595b318f71d62e/Werkzeug-1.0.1-py2.py3-none-any.whl (298kB)
    100% |████████████████████████████████| 307kB 1.6MB/s 
Requirement already satisfied: six>=1.3.0 in /usr/lib/python3.6/site-packages (from flask_restful==0.3.8->-r requirements.txt (line 2))
Collecting pytz (from flask_restful==0.3.8->-r requirements.txt (line 2))
