...
[source,bash]
----
$ oc whoami     # the opentlc-mgr happens to be cluster-admin on my system
opentlc-mgr 
...
Here is what we will have if we list the images:
...
image:registry-container-deploy[How it is done!]
