...
in server.run(debug=True,host='0.0.0.0, port=8080)

Requirements first, then dependencies, then source
...
podman run -it --rm rhel8/python-38 /opt/app-root/bin/python
